...
OUTPUT_ = [
    ...
    FormField(4, "Border Top (Y overlap band)", None, {"min": 0, "max": 32767}, "int32", "number"),
    FormField(5, "Border Bottom (Y overlap band)", None, {"min": 0, "max": 32767}, "int32", "number"),
    FormField(13, "Border Left (X overlap when switching vertically)", None, {"min": 0, "max": 32767}, "int32", "number"),
    FormField(14, "Border Right (X overlap when switching vertically)", None, {"min": 0, "max": 32767}, "int32", "number"),
    FormField(6, "Operating System", 1, {1: "Linux", 2: "MacOS", 3: "Windows", 4: "Android", 255: "Other"}, "uint8"),
    FormField(7, "Screen Position (relative to the other PC)", 1, {1: "Left", 2: "Right", 4: "Top", 5: "Bottom"}, "uint8"),
